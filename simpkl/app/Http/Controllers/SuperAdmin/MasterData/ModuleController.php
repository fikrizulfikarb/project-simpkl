...
class ModuleController extends Controller
{
    ...
    public function store()
    {
        ...
        return redirect('superadmin/master-data/module');
    }
    ...
    {
        $module->delete();
        return redirect('superadmin/master-data/module')->with('danger','berhasil di hapus');
    }
    ...
    public function addRole()
    {
        ...
        $role->id_dataperusahaan = request('id_dataperusahaan');
